...
namespace FINMUE.Controllers
{
    public class InmuebleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InmuebleId,TipoDeInmueble,Nombre,Domicilio,Costo,Status,FechaActualizacion")] Inmueble inmueble)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InmuebleId,TipoDeInmueble,Nombre,Domicilio,Costo,Status,FechaActualizacion")] Inmueble inmueble)
        {
        ...
        {
            if (_context.Inmueble == null)
            {
                return Problem("Entity set 'DataContext.Inmueble'  is null.");
            }
            var inmueble = await _context.Inmueble.FindAsync(id);
            if (inmueble != null)
            {
